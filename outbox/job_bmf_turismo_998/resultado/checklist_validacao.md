...
| Contrato                   | QSA Administrador                      | APROVADO  | contrato.pdf p.3 "FERNANDO DE LIMA VILA NOVA"      | -                     |
| Contrato                   | Prova de assinatura/registro           | APROVADO  | contrato.pdf p.3 "Registro na Junta Comercial"      | -                     |
| CPF do representante        | CPF do representante                   | APROVADO  | cpf_cnh.png p.1 "105.214.676-75"                     | -                     |
...
```json
{
          ...
          "evidencias": [
            {
              "arquivo": "contrato.pdf",
              "pag": 3,
              "trecho": "Registro na Junta Comercial"
            }
          ]
        }
      },
  ...
  "decisao_final": {
    ...
    "justificativa": "Todos os documentos estão em conformidade.",
    "acoes_recomendadas": []
  }
}
```
